...
export type PropsWithChildren<T, K = Children | undefined> = T & (K extends undefined ? { children?: K } : { children: K });

export type FC<T = {}> = (props: T extends { children: any } ? T : PropsWithChildren<T>) => ElementNode | null;
 ...
 */
export type RawFC<T = {}, K = T, C = Children | undefined> = (props: PropsWithChildren<T, C>) => RawElement<K>;
