...
import { type HistoricalEnabledMetadata, type HistoricalMetadata, type MetadataEntry, MetadataScanner } from "#metadata";
...
export class HistoricalScanner {
	...
	public static getHistoricalField<T>(constructor: Constructor<T>, key: string, leaderboardMustBeEnabled?: true): HistoricalEnabledMetadata;
	public static getHistoricalField<T>(constructor: Constructor<T>, key: string, leaderboardMustBeEnabled: false): HistoricalMetadata;
	public static getHistoricalField<T>(constructor: Constructor<T>, key: string, leaderboardMustBeEnabled = true): HistoricalMetadata {
		...
		if (!historical.enabled && leaderboardMustBeEnabled) throw new Error(`${key} is not a historical leaderboard field for ${constructor.name}`);
