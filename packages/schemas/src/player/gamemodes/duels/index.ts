...
export const DUELS_MODES = new GameModes([
  ...
  { hypixel: "DUELS_MW_DOUBLES", formatted: "MegaWalls Doubles" }, // Needed for calculation of MW Overall
  ...
  { hypixel: "DUELS_BRIDGE_FOUR", formatted: "Bridge Fours" },
    { hypixel: "DUELS_BRIDGE_2V2V2V2", formatted: "Bridge 2v2v2v2" }, // Needed for calculation of Bridge Overall
  { hypixel: "DUELS_BRIDGE_3V3V3V3", formatted: "Bridge 3v3v3v3" }, // Needed for calculation of Bridge Overall
  { hypixel: "DUELS_CAPTURE_THREES", formatted: "Bridge CTF" }, // Needed for calculation of Bridge Overall
