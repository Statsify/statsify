...
export class HypixelSays {
	...
	public constructor(data: APIData) {
		...
		this.maxScore = Math.max(data.top_score_simon_says ?? 0, data.top_score_santa_says ?? 0);
	}
}
...
export class Seasonal {
	...
	public constructor(data: APIData) {
		...
		this.totalWins = add(this.easterSimulator.wins, this.grinchSimulator.wins, this.halloweenSimulator.wins, this.scubaSimulator.wins);
	}
}
