...
export { METADATA_KEY } from "./metadata/constants.js";
...
export * from "./metadata/deserialize.js";
export * from "./metadata/metadata-scanner.js";
export * from "./metadata/metadata.interface.js";
export * from "./metadata/serialize.js";
