...
import type { APIApplicationCommandOptionChoice, ApplicationCommandOptionType, ChannelType } from "discord-api-types/v10";
import type { CommandContext } from "#command";

export interface AbstractArgument {
	autocompleteHandler?(context: CommandContext): APIApplicationCommandOptionChoice[] | Promise<APIApplicationCommandOptionChoice[]>;
}
