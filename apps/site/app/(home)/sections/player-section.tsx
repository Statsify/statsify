    ...
    >
      <div className="mx-4 lg:mx-0 flex flex-col gap-4 max-w-100 xl:max-w-120 text-mc-white text-center lg:text-start ">
        ...
        <p className="text-mc-1.75 lg:text-mc-2 leading-6">
          ...
          Discord command to view your stats. For example, run the <Command command="/bedwars" /> command to check your
          BedWars stats! Make sure to verify using <Command command="/verify" /> to make running Statsify&apos;s
          commands easier and faster, and explore the rest of the provided features.
        </p>
      </div>
