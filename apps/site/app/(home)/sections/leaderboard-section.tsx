...
export function LeaderboardSection({ leaderboard }: { leaderboard: PostLeaderboardResponse }) {
  return (
    <BaseSection background="uhc" className="flex-col-reverse lg:flex-row justify-between lg:items-center lg:py-0">
      ...
      <div className="mx-auto lg:mx-0 flex flex-col gap-4 max-w-100 xl:max-w-150 text-mc-white text-center lg:text-start ">
        ...
        <p className="text-mc-2 leading-6">
          Explore more than 2,000 Hypixel games leaderboards with Statsify! Leaderboards can be viewed by using the{" "}
          <Command>/leaderboard</Command> command followed by the desired game and stat. Try{" "}
          <Command>/leaderboard uhc leaderboard: score</Command> for an example.
        </p>
      </div>
    </BaseSection>
  );
