  ...
  if (User.isNetherite(user) && user?.footer?.message) text = user.footer.message;
    ...
    switch (logo) {
      ...
      case UserLogo.NETHERITE:
        text =
          "§#5d5b5ds§#575557t§#514f51a§#4b494bt§#454345s§#3e3c3ei§#373637f§#302f30y§#2d2b2c.§#2b2829n§#2a2425e§#282122t";
        break;
      ...
      case UserLogo.PINK:
        text =
          "§#fec0d4s§#fbb9d5t§#f9b3d6a§#f6acd7t§#f4a5d5s§#f59bcci§#f692c2f§#f788b9y§#f189c2.§#e98fd4n§#e094e7e§#d89af9t";
        break;
