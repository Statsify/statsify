...
export const HistoricalHeader = ({ skin, nameTag, title, sidebar, time: { timeType, startTime, endTime, sessionReset } }: HistoricalHeaderProps) => {
				...
				<box width="100%" height="remaining">
					<text>
						{timeType === HistoricalTimes.SESSION
							? `Started ${sessionReset?.toFormat(DATE_FORMAT)} (${sessionReset?.toRelative()})`
