...
import { BridgeDuelsTable, MultiDuelsGameModeTable, SingleDuelsGameModeTable, UHCDuelsTable } from "./tables/index.js";
...
export const DuelsProfile = ({ skin, player, background, logo, user, badge, mode, t, time }: DuelsProfileProps) => {
	...
	return (
		<Container background={background}>
			<Header
				...
				description={`§7${t("stats.title")}: ${duels[api].titleFormatted}\n${formatProgression({
					t,
