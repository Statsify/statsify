...
export const TNTGamesProfile = ({ player, background, logo, skin, t, badge, user, time }: BaseProfileProps) => {
	...
	return (
		<Container background={background}>
			<Header skin={skin} name={player.prefixName} badge={badge} sidebar={sidebar} title={`§l${FormattedGame.TNT_GAMES} §fStats`} time={time} />
			<Table.table>
				<Table.tr>
					<TNTGamesModeColumn
						title="PVP Run"
