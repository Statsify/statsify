  ...
  public async run() {
    const embed = new EmbedBuilder()
      ...
      .description((t) => {
        ...
        desc += '\n';
        desc += `${t('emojis:colors.k')} \`§k\` • ${t('embeds.colors.description.obfuscated')}\n`;
        desc += `${t('emojis:colors.l')} \`§l\` • **${t('embeds.colors.description.bold')}**\n`;
        desc += `${t('emojis:colors.m')} \`§m\` • ~~${t(
          'embeds.colors.description.strikethrough'
        )}~~\n`;
        desc += `${t('emojis:colors.n')} \`§n\` • _${t('embeds.colors.description.underline')}_\n`;
        desc += `${t('emojis:colors.o')} \`§o\` • *${t('embeds.colors.description.italic')}*\n`;
        desc += `${t('emojis:colors.r')} \`§r\` • ${t('embeds.colors.description.reset')}\n`;
