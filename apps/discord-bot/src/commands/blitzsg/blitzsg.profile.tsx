...
import { BlitzSG, BlitzSGKit, BlitzSGModes, FormattedGame, GameMode, Player } from "@statsify/schemas";
...
export function filterBlitzKits(player: Player, modes: GameMode<BlitzSGModes>[]): GameMode<BlitzSGModes>[] {
	const { blitzsg } = player.stats;
