  ...
  return (
    <Table.table>
      ...
      <Table.tr>
        ...
        <ZombiesMapColumn title="§#75ae00Alien Arcadium" stats={alienArcadium} t={t} time={time} />
        <ZombiesMapColumn title="§#aaa5c2Prison" stats={prison.overall} t={t} time={time} />
      </Table.tr>
    </Table.table>
  );
};
    ...
    <Historical.exclude time={time}>
      <Table.tr>
        <Table.td
          ...
          value={stats.fastestWin ? formatTime(stats.fastestWin) : "N/A"}
          color="§b"
          size="small"
        />
...
export const ZombiesMapTable = ({ stats, t, time, map }: ZombiesMapTableProps) =>
  map === "alienArcadium" ? (
