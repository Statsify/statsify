...
const GeneralProfileHeaderBody = ({ guild, status, t }: GeneralProfileHeaderBodyProps) => {
	...
	const lastLogin = status.lastLogin ? DateTime.fromMillis(status.lastLogin).toFormat(format, { locale: t.locale }) : "N/A";
...
export const GeneralProfile = ({ background, logo, player, skin, t, badge, user, guild, time }: GeneralProfileProps) => {
