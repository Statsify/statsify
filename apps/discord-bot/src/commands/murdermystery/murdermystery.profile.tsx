...
export const MurderMysteryProfile = ({
      ...
      table = (
        <Table.table>
          ...
          <Table.tr>
            ...
            <Table.td title={t("stats.killsAsAlpha")} value={t(stats.killsAsAlpha)} color="§4" />
          </Table.tr>
        </Table.table>
      );
  ...
  if (murdermystery.knife.progression.percent >= 1) description.push(`§7${t("stats.progression.exp")}: §l§dPRESTIGED`);
  else
    description.push(
