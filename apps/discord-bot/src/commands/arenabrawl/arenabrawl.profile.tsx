...
export const ArenaBrawlProfile = ({ skin, player, background, logo, user, badge, mode, t, time }: ArenaBrawlProfileProps) => {
	...
	if (time === "LIVE" && "winstreak" in stats && stats["winstreak"] > 0) sidebar.push([t("stats.winstreak"), t(stats.winstreak), "§a"]);
