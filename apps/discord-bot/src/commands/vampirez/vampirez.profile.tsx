...
export const VampireZProfile = ({ skin, player, background, logo, user, badge, t, time, mode }: VampireZProfileProps) => {
		...
		<Container background={background}>
			...
			<Table.table>
				<Table.tr>
					...
					<Table.td title={api === "human" ? t("stats.vampires-killed") : t("stats.humans-killed")} value={t(vampirez[api].kills)} color="§a" />
