...
import { Container, Footer, Header, Historical, If, SidebarItem, Table, formatProgression } from "#components";
import { FormattedGame, GameMode, WoolWarsModes, WoolWarsOverall } from "@statsify/schemas";
...
export const WoolWarsProfile = ({ skin, player, background, logo, user, badge, mode, t, time }: WoolWarsProfileProps) => {
	...
	return (
		<Container background={background}>
			<Header
				...
				description={`§7${t("stats.level")}: ${woolwars.levelFormatted}\n${formatProgression({
					t,
