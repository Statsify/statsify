...
export const render: Render<Box.BoxRenderProps> = (
	...
	if (border.bottomRight) {
		ctx.fillRect(x + width - border.bottomRight, y + height - border.bottomRight - border.bottomRight, shadowDistance, shadowDistance);

		ctx.fillRect(x + width - border.bottomRight - border.bottomRight, y + height - border.bottomRight, shadowDistance, shadowDistance);
	}
