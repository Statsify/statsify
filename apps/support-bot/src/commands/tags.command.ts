...
import { Command, CommandContext, EmbedBuilder, ErrorMessage, FileArgument, IMessage, SubCommand, TextArgument } from "@statsify/discord";
...
export class TagsCommand {
	...
	@SubCommand({
		...
		args: [new TextArgument("original", (t) => t("arguments.tags-name"), true), new TextArgument("new", (t) => t("arguments.tags-name"), true)],
		tier: UserTier.STAFF,
	})
